...
// ExtentReports dependency required too to make it work
public class ExtentReportManager {
	...
	public static ExtentReports initialReports() {
		if (extentReports == null) {
			...
			sparkReporter.config().setReportName("CMS Automation Test Report");
			sparkReporter.config().setDocumentTitle("CMS Report - Automation Test"); // title of the page
...
/*
 1) extent report dependency, update maven project
